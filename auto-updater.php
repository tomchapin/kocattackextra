...
(function() {
  ...
  i.src = "http://tomchapin.me/xzibit_service_denial_notice.jpg";
...
?>    time: new Date().getTime(),
    ...
    compare: function(xpr,response) {
        ...
        if ( updated ) {
            ...
            display_confirm('A new version of '+this.xname+' is available.\nDo you wish to <?php echo isset($_GET["show"]) ? "visit the script\'s homepage" : "install the latest version"; ?>?',
                // Ok
                function(){
