	...
	*/	
	...
	SetAttackFromGuiXY:function(x,y,box,isSuicideWave,isTransport) {
		if(!isSuicideWave){
			...
			var otherIsSuicideWaveCheckbox = ById('KOCAttackSuicideWaveCheckbox').checked;
			if(otherIsSuicideWaveCheckbox){isSuicideWave = true;}
		}
		if(!isTransport){
		...
		if(marchType==0 && !isTransport) {
			...
			if((SuicideAttackDefined && firstAttack) || isSuicideWave) {
	...
	BulkAddAttackLink:function(box) {
		...
		bulkAddSuicideCheckbox.addEventListener('click',function() {
			...
			if(bulkAddSuicideWaveCheckbox && suicideWaveCheckbox && bulkAddLocationType_Wilderness){
	...
	OnAttackBoxAppear:function(box) {
		...
		suicideCheckbox.addEventListener('click',function() {
			var bulkAddSuicideWaveCheckbox = ById("KOCAttackBulkAddSuicideWave");
			var bulkAddLocationType_Wilderness = ById("KOCAttackBulkAddLocationType_Wilderness");
			if(bulkAddSuicideWaveCheckbox && bulkAddLocationType_Wilderness){
