...
var KOCAttack={
	...
	*/
	...
	GetLevelInfo:function(attack) {
		...
		if((!levelI || levelI.level==0 || levelI.type=="") && attack.messages && attack.messages.length>0) { //The idea is to replace all old attacks with the new one
