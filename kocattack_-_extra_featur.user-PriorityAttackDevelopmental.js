	...
	*/
	...
	FindBiggestCampAttack:function(attacks,currentTroops,currentResources) {
		...
		for(var a=0; a<attacks.length; a++) {
			...
			// //attackpriority (Inder development) ~~
			// if(ok) {
				// bestAttacktemp=attack;
				// bestAttacktemp.type=attack.a.type;
				// bestAttackSize=armySize;
			// }
			
			// if((this.options.attackpriority == levelInfo.type || this.options.attackpriority == 'None') && ok){
				// bestAttack=attack;
				// bestAttack.type=attack.a.type;
				// bestAttackSize=armySize;
			// }
			
			// if(a == (attacks.length-1) && bestAttack == null){
				// bestAttack=attack;
				// bestAttack.type=attack.a.type;
				// bestAttackSize=armySize;
				// break;
